...
public static b4a.example.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"HttpUtils2Service",Debug.moduleToString(b4a.example.httputils2service.class),"LazyLoadingPage",Debug.moduleToString(b4a.example.lazyloadingpage.class),"Main",Debug.moduleToString(b4a.example.main.class),"modCommon",Debug.moduleToString(b4a.example.modcommon.class),"Service",starter.mostCurrent._service,"svcProduction",Debug.moduleToString(b4a.example.svcproduction.class)};
}
}