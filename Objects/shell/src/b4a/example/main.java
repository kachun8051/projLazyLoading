...
public static b4a.example.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"CLV1",main.mostCurrent._clv1,"HttpUtils2Service",Debug.moduleToString(b4a.example.httputils2service.class),"ImageView1",main.mostCurrent._imageview1,"LazyLoadingPage",Debug.moduleToString(b4a.example.lazyloadingpage.class),"lblAction1",main.mostCurrent._lblaction1,"lblAction2",main.mostCurrent._lblaction2,"lblContent",main.mostCurrent._lblcontent,"lblTitle",main.mostCurrent._lbltitle,"modCommon",Debug.moduleToString(b4a.example.modcommon.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"svcProduction",Debug.moduleToString(b4a.example.svcproduction.class),"xui",main._xui};
}
}